...
import type { AuthAction, InternalOptions, ResponseInternal } from "../../../../types.js"
...
export function validateCSRF(action: AuthAction, verified?: boolean): ResponseInternal<any> {
  if (verified) return { status:  200, body: {} };
